...
# generate_Code
tages_needed_to_generate_code = {}
tages_needed_to_generate_code['img'] = "<img src='https://img.icons8.com/plasticine/2x/image.png' alt =''/><br>\n" 
tages_needed_to_generate_code['button'] = "<button type='button'>button</button><br>\n"
tages_needed_to_generate_code['text'] = "<input type='text' name='Text'><br>\n"
tages_needed_to_generate_code['dropdown'] = "<select>\n<option value='opt1'>opt1</option>\n<option value='opt2'>opt2</option>\n</select><br>\n"
tages_needed_to_generate_code['radio'] = "<input type='radio' name='radio' value='radio'>radio<br>\n"
tages_needed_to_generate_code['checkbox'] = "<input type='checkbox' name='checkbox' value='checkbox'>checkbox<br>\n"

def generate_Code(box_to_color_map , name_of_the_classes):
  ...
  for box, color in box_to_color_map.items():
      ...
      (left, right, top, bottom) = (xmin * im_width, xmax * im_width,
                                      ymin * im_height, ymax * im_height)
      code = code + tages_needed_to_generate_code[name_of_the_classes[box][0]]
  return code + "\n</html>"
...
def visualize_boxes_and_labels_on_image_array(
    ...
    name_of_the_classes = collections.defaultdict(list)
            ...
            if scores is None:
                ...
                if not skip_labels:
                    if not agnostic_mode:
                        ...
                        name_of_the_classes[box].append(display_str)
...
# get the border and the class name 
  
    code = generate_Code(box_to_color_map , name_of_the_classes)

    
    
# end of  get the border and the class name 
